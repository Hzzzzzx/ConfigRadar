...
final class ScanPipelineTest {
    ...
    void defaultPipelineFindsSpringConfigFiles() throws Exception {
        ...
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("nested.outer") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
        ...
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("NESTED_URL") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("NESTED_HOST") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
        ...
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("location.extra.enabled") && item.role() == FindingRole.DEFINE));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("location.extra.secret") && item.role() == FindingRole.DEFINE));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("LOCATION_EXTRA_SECRET") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
        ...
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("LOG_NESTED_OUTER") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("LOG_NESTED_INNER") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
        ...
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("inventory.client.name") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("inventory.client.url") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
        ...
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("java.json.enabled") && item.role() == FindingRole.DEFINE));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("javaEnv.json.limit") && item.role() == FindingRole.DEFINE));
        assertTrue(result.inventory().items().stream()
        ...
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("resilience.orders.circuitbreaker") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("resilience.orders.retry") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("resilience.orders.ratelimiter") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("resilience.orders.bulkhead") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
        ...
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("spring.config.additional-location[0]")
                && item.role() == FindingRole.METADATA));
        assertTrue(result.inventory().items().stream()
        ...
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("configtree.username") && item.role() == FindingRole.DEFINE));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("configtree.timeout") && item.role() == FindingRole.DEFINE));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("list.extra.enabled") && item.role() == FindingRole.DEFINE));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("list.extra.secret") && item.role() == FindingRole.DEFINE));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("LIST_EXTRA_SECRET") && item.role() == FindingRole.READ));
        assertTrue(result.inventory().items().stream()
        ...
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("mp.mode")));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("mp.timeout")));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("mp.raw")));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("typesafe.servers")));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("typesafe.experimental")));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("preferences.mode")));
        assertTrue(result.inventory().items().stream()
        ...
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("DOCKER_APP_MODE")));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("DOCKER_FEATURE_ENABLED")));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("DOCKER_SERVER_PORT")));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("DOCKER_JAVA_OPTS")));
        assertTrue(result.inventory().items().stream()
            .anyMatch(item -> item.key().equals("file.encoding")));
        assertTrue(result.inventory().items().stream()
